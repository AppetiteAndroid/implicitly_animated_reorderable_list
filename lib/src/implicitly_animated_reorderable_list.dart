...
class ImplicitlyAnimatedReorderableList<E extends Object> extends ImplicitlyAnimatedListBase<Reorderable, E> {
...
class ImplicitlyAnimatedReorderableListState<E extends Object> extends ImplicitlyAnimatedListBaseState<Reorderable, ImplicitlyAnimatedReorderableList<E>, E> {
  ...
  void onDragUpdated(double delta) {
    ...
    final maxDelta = ((_maxScrollOffset + _listSize + overscrollBound) - (dragItem!.bottom + _footerHeight)) - _scrollDelta + epsilon;
